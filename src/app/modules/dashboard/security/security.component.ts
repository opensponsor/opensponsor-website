...
import {SecurityForUserComponent} from "@modules/dashboard/security-for-user/security-for-user.component";
import {
  SecurityForOrganizationComponent
} from "@modules/dashboard/security-for-organization/security-for-organization.component";
